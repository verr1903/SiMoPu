        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img src="./../assets/compiled/svg/error-404.svg" alt="Not Found" style="max-height: 280px; margin-bottom: 1rem;">
                    <h1 class="error-title">404 - NOT FOUND</h1>
                    <p class="error-subtitle">Halaman yang Anda cari tidak ditemukan.</p>
                    <a href="{{ route('dashboard') }}" class="btn btn-primary btn-home">Kembali ke Dashboard</a>
                </div>
            </div>
        </div>
